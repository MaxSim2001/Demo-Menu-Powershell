# Executer avec : .\Resize_script.ps1 -SkipConfirmation $true -BackupFolder c:\winre_backup


   Param (
[Parameter(Mandatory=$false,HelpMessage="Skip confirmation")]$SkipConfirmation=$false,
